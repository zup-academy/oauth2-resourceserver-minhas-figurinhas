...
class ListaAlbunsControllerTest extends SpringBootIntegrationTest {
    ...
    @Test
    public void naoDeveListarTodosOsAlbuns_quandoAccessTokenNaoEnviado() throws Exception {
        // cenário
        List.of(
                new Album("DBZ", "Album do DBZ", "rafael.ponte"),
                new Album("CDZ", "Album do CDZ", "jordi.silva"),
    ...
    @Test
    public void naoDeveListarTodosOsAlbuns_quandoAccessTokenNaoPossuiScopeApropriado() throws Exception {
        // cenário
        List.of(
                new Album("DBZ", "Album do DBZ", "rafael.ponte"),
                new Album("CDZ", "Album do CDZ", "jordi.silva"),
